...
export default function App() {
  ...
  const trimiteWiseWeee = (r) => {
    ...
    const payload = {
      source: "greenkraft",
      furnizor: r.furn || "",
      nr_document: [r.serie, r.nr_doc].filter(Boolean).join(" "),
