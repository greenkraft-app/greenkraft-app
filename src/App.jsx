    ...
    <div style={{ fontFamily: "Segoe UI,sans-serif", background: "#f0f4f0", minHeight: "100vh", padding: 12 }}>
        ...
        <div onClick={() => setTicEdit(null)} style={{ position: "fixed", inset: 0, background: "rgba(0,0,0,0.55)", zIndex: 9999, display: "flex", alignItems: "center", justifyContent: "center", padding: 16 }}>
          <div onClick={(e) => e.stopPropagation()} style={{ background: "#fff", borderRadius: 10, width: "min(96vw,440px)", display: "flex", flexDirection: "column", boxShadow: "0 8px 40px rgba(0,0,0,0.35)", overflow: "hidden" }}>
            ...
            <div style={{ padding: "14px 18px", display: "flex", flexDirection: "column", gap: 10, maxHeight: "70vh", overflowY: "auto" }}>
              {ticEdit.status === "gol" && (
                <div>
                  <label style={{ fontSize: 11, fontWeight: 600, color: "#555" }}>Tip</label>
                  <div style={{ display: "flex", gap: 8 }}>
                    <button onClick={() => setTicEdit((p) => ({ ...p, tip: "Intrare" }))} style={{ flex: 1, padding: "7px", border: `1.5px solid ${G}`, borderRadius: 5, background: ticEdit.tip === "Intrare" ? G : "#fff", color: ticEdit.tip === "Intrare" ? "#fff" : G, cursor: "pointer", fontSize: 12, fontWeight: 700 }}>▼ Intrare</button>
                    <button onClick={() => setTicEdit((p) => ({ ...p, tip: "Iesire" }))} style={{ flex: 1, padding: "7px", border: "1.5px solid #bf360c", borderRadius: 5, background: ticEdit.tip === "Iesire" ? "#bf360c" : "#fff", color: ticEdit.tip === "Iesire" ? "#fff" : "#bf360c", cursor: "pointer", fontSize: 12, fontWeight: 700 }}>▲ Ieșire</button>
                  </div>
                </div>
              )}
      ...
      <div style={{ background: "#fff", border: "1px solid #ccc", borderTop: "none", borderRadius: "0 0 8px 8px", padding: 14, boxShadow: "0 2px 8px rgba(0,0,0,.08)" }}>
        ...
        {tab === "cantar" && (() => {
          ...
          // Ordinea e mereu dupa nr. de tichet, indiferent de status (inchis sau rezervat) — cele
          // rezervate n-au o ora reala de cantarire (doar ora la care au fost rezervate, care poate
          // insela), asa ca sortarea dupa data/ora le-ar scoate din locul lor firesc in registru.
          ...
          const filtrate = sortByNrTichetAsc([...inchise, ...goale]).filter((t) => {
