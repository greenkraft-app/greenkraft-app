          ...
          <div>
            ...
            <div style={{ overflowX: "auto" }}>
              <table style={{ borderCollapse: "collapse", width: "100%" }}>
                ...
                <thead><tr><th style={th({ width: 28 })}></th>{["Data", "GK/Deee", "Suma(lei)", "Categorie", "Detalii", "Ach.", "Achitat De", "Note"].map((h, ci) => <th key={ci} style={th({ textAlign: ci === 2 ? "right" : "left" })}>{h}</th>)}<th style={th({ width: 28 })}></th></tr></thead>
          ...
          <div>
            ...
            <div style={{ overflowX: "auto" }}>
              <table style={{ borderCollapse: "collapse", width: "100%" }}>
                ...
                <thead><tr><th style={th({ width: 28 })}></th><th style={th({})}>Data</th><th style={th({})}>Agent</th><th style={th({})}>Furnizor</th><th style={th({})}>Cat.</th><th style={th({ textAlign: "left" })}>Produs</th><th style={th({})}>Cant.(kg)</th><th style={th({})}>Preț</th><th style={th({})}>Total</th><th style={th({})}>F. Imp.12%</th><th style={th({})}>Ach.</th><th style={th({})}>Achitat De</th><th style={th({ width: 28 })}></th></tr></thead>
          ...
          <div>
            ...
            <div style={{ overflowX: "auto" }}>
              <table style={{ borderCollapse: "collapse", width: "100%", tableLayout: "fixed" }}>
                <colgroup><col style={{ width: 28 }} /><col style={{ width: 78 }} /><col style={{ width: 50 }} /><col style={{ width: 115 }} /><col /><col style={{ width: 70 }} /><col style={{ width: 60 }} /><col style={{ width: 78 }} /><col style={{ width: 65 }} /><col style={{ width: 65 }} /><col style={{ width: 130 }} /><col style={{ width: 28 }} /></colgroup>
                <thead><tr><th style={th({})}></th><th style={th({})}>Data</th><th style={th({})}>Nr.</th><th style={th({})}>Client</th><th style={th({ textAlign: "left" })}>Produs</th><th style={th({})}>Cant.(kg)</th><th style={th({})}>Preț</th><th style={th({})}>Total(lei)</th><th style={th({})}>Fact.</th><th style={th({})}>Înc.</th><th style={th({ textAlign: "left" })}>Detalii</th><th style={th({})}></th></tr></thead>
